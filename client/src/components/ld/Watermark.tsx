// v16.5 — Identity watermark overlay.
//
...
export default function Watermark() {
  ...
  const style: React.CSSProperties = {
    ...
    // v16.5 — media query at runtime: darker on dark backgrounds is impossible
  ...
  return <div aria-hidden="true" data-watermark="lead-depot-v16.5" style={style} />;
}
