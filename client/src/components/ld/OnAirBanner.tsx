// v15.11.11 — Tappable Prime Time banner + prime-transition haptic. (User-facing label
// renamed from "On Air" → "Prime Time" per Alex 2026-07-13 morning. Component filename
// kept as OnAirBanner to avoid churning imports across the codebase.)
//
// Renders 24/7. Three states:
//   PRIME   → red "PRIME TIME" plate, flashing broadcast light both ends
