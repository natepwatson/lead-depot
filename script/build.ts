...
async function buildAll() {
  ...
  // v20.37.9 — Lexi (Kokoro/Piper voice assistant) removed from the app.
  // Kokoro + Piper voice-asset copy steps deleted along with server/assistant.ts,
  // server/tts.ts, server/tts-piper.ts, server/kokoro-cache/, server/piper-cache/.
}
