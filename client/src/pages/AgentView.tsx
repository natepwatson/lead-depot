  ...
  return (
    <div style={{
      ...
      <div style={{ padding: "22px 20px 16px" }}>
        ...
        {/* v19.2 — Zillow Intel (public scrape, 24h cache). Renders inline if scrape succeeds.
...
// v19.2 — HomeShell wraps LeaderboardTab with a small "Board ↔ Team Map"
...
// v19.2 — ZillowIntelPanel: lazy-loads /api/zillow/intel when a lead detail
...
function MyLeadsTab({ onOpenLead }: { onOpenLead?: (leadId: number) => void }) {
  ...
  // v19.2 — Pipeline view toggle: List (default, phone-friendly) or Kanban (6 stages).
...
// v19.2 — KanbanBoard: 6-column horizontally-scrollable board.
...
export default function AgentView({ onBackToAdmin, onOpenAdmin, initialTab, mode = "seller" }: { onBackToAdmin?: () => void; onOpenAdmin?: () => void; initialTab?: Tab; mode?: "seller" } = {}) {
  ...
  // v19.2 — Prime Time notifier boot. Idempotent; only fires when permission is granted.
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 2 }}>
              ...
              <span style={{ fontSize: 9, color: "rgba(200,170,90,0.55)", letterSpacing: "0.10em", fontWeight: 700 }}>v19.2</span>
            </div>
          </div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
