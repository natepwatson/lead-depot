    ...
    <div style={{ minHeight: "100dvh", background: "#eeeeec", fontFamily: "Helvetica,Arial,sans-serif", padding: "0 0 60px" }}>
      <div style={{ maxWidth: 640, margin: "0 auto", background: "#fff", boxShadow: "0 4px 30px rgba(0,0,0,0.08)" }}>
        ...
        <div style={{ padding: "26px 32px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", padding: "4px 0", fontSize: 12.5, color: "#666" }}>
            <span>Deposit due to begin (50%)</span><span>${consult.depositAmount.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
          </div>
