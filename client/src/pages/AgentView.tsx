...
function ChallengesTab() {
  ...
  // v20.7.40 — hide bottom nav while claim sheet or unlock celebration is open,
  ...
  // v20.7.40 — optional photo evidence on the claim sheet. Every gated challenge
      ...
      {claimOpen && (
        <div onClick={() => { setClaimOpen(null); setClaimPhotoDataUrl(null); }} style={{
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            {/* v20.7.40 — optional photo evidence. Every gated challenge asks for one
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 2 }}>
              ...
              <span style={{ fontSize: 9, color: "rgba(200,170,90,0.55)", letterSpacing: "0.10em", fontWeight: 700 }}>v20.7.40</span>
            </div>
          </div>
          {onBackToAdmin && (
...
function SocialPostForm(props: { user: any; toast: any; onDone: () => void }) {
  ...
  // v20.7.40 — Video is a WHOLE-LOG BONUS on top of platform points, not a
  ...
  // v20.7.40 — single log-level video flag.
  ...
  // v20.7.40 — scoring: (10 × platforms) + (isVideo ? 80 : 0). Video is a bonus.
  ...
  const submit = async () => {
    ...
    try {
      ...
      // v20.7.40 — single log-level video flag. Server computes
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
      ...
      {/* v20.7.40 — single log-level Video toggle. Not per-platform. */}
      <div>
        <button
          type="button"
