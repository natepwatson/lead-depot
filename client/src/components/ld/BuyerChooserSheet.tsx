// v20.33.0 — "Place an Offer" bottom-nav button now opens this chooser
// overlay first: dark radial-gradient backdrop with 2 circular gold-gradient
// bubbles ("Write an Offer" and "Inspections+"), matching the Lead Gen
// chooser's visual language (gold liquid-glass bubbles on a dark scrim).
import { useEffect } from "react";
import { FileSignature, ClipboardCheck, X } from "lucide-react";
...
export function BuyerChooserSheet({
  onWriteOffer, onInspectionsPlus, onClose,
}: {
  onWriteOffer: () => void;
  ...
  return (
    ...
    >
      ...
      <div onClick={e => e.stopPropagation()} style={{ display: "flex", gap: 24, alignItems: "center" }}>
