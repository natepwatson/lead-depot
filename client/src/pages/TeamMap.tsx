...
//
// v20.14.3 — Alex: strip the map down to ONLY the leads we've uploaded — that's
// the whole point of the map. Removed the Active Listings layer, the Open
// House layer, and the top-left inventory/OH legend entirely (including their
// /api/listings/active-map and /api/open-houses/upcoming fetches). Nothing
// else on this page renders anything but lead pins now.
