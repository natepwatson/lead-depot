...
// - Handles `push` events (v15.11) so agents get Prime Time alerts on
...
// v15.11 — Web Push event. Payload is JSON: { title, body, url, tag }.
...
// v15.11 — Focus/open the app when the notification is tapped.
