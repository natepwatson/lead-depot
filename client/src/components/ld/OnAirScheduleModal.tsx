        ...
        >
          ...
          <div style={{ display: "flex", gap: 10, marginBottom: 10, fontSize: 9, letterSpacing: "0.08em", textTransform: "uppercase", color: "rgba(243,243,243,0.6)", flexWrap: "wrap" }}>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 5 }}>
              <span style={{ width: 9, height: 9, borderRadius: 2, background: "linear-gradient(180deg,#ef4444,#b91c1c)" }} />On Air
            </span>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 5 }}>
              <span style={{ width: 9, height: 9, borderRadius: 2, background: "linear-gradient(180deg,#f59e0b,#b45309)" }} />Mid
            </span>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 5 }}>
              <span style={{ width: 9, height: 9, borderRadius: 2, background: "#1f2937" }} />Off Air
            </span>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 5 }}>
          ...
          {hoverCell && hoverTier && (
            <div style={{
              ...
              {hoverReason || (
                ...
                "Low-yield window. Save leads for On Air."
              )}
            </div>
          )}
