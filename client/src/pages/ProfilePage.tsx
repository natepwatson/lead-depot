...
const CHANGELOG: { version: string; date: string; note: string }[] = [
  { version: "v15.11.3", date: "Jul 12", note: "Simplified Prime Time notifier. The always-visible bar at the top of every screen IS the notifier — no separate push, no opt-in, no permission prompts. If you have the app open you see the tier; that's it. Removed the web-push subscription system entirely." },
